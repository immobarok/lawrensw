...
import { getCruiseSvalbardSeo } from "@/api/seo/seoTitle";
...
export async function generateMetadata({
  ...
  try {
    const seoData = await getCruiseSvalbardSeo(lang);
    const title = (seoData as any)?.data?.data?.title || "Cruise Svalbard";
    const description =
      (seoData as any)?.data?.data?.description ||
      "Explore Svalbard with our cruise packages.";
    ...
    return {
      ...
      description: "Explore Svalbard with our cruise packages.",
    };
  }
}
